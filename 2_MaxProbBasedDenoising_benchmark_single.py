...
from denoising_strategies import MaxProbBasedDenoising
import os
...
# Instantiate the MaxProbBasedDenoising strategy with specific parameters
# Using the same parameters as the EntropyBasedDenoising benchmark for consistency
...
if __name__ == '__main__':
    ...
    # results = runner.run_benchmark(denoising_strategy, strategy_name="MaxProbBasedDenoising")
    # Uncomment to use the parallel version:
    results = runner.run_benchmark_parallel(denoising_strategy, strategy_name="MaxProbBasedDenoising", n_processes=8)
